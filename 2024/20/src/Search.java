...
public class Search
{
  public static final long print_every=100000;
  ...
  public static Map<String, State> searchM(List<State> starts)
  {
    ...
    TreeMap<String, State> fins = new TreeMap<>();
    ...
    while(!queue.isEmpty())
    {
      ...
      if (s.isTerm())
      {
        ...
        if ((!fins.containsKey(str)) || (fins.get(str).getCost() > s.getCost()))
        {
          System.out.println("Search solution: " + s + " " + s.getCost());
          fins.put(str, s);
        }
      }
  ...
  public static Map<String, State> search(State start)
  {
